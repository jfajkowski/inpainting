...
parser.add_argument('--input-dir', type=str, default='data/processed/video/DAVIS/Annotations_unsupervised/480p')
parser.add_argument('--output-dir', type=str, default='data/processed/video/DAVIS/Annotations_dilated/480p')
...
def dilate(mask, kernel_size, iterations):
    ...
    mask = 255 - mask
    mask = cv.dilate(mask, structuring_element, iterations=iterations)
    return 255 - mask
