...
from inpainting.external.algorithms import DeepFlowGuidedVideoInpaintingAlgorithm, SiamMaskVideoTrackingAlgorithm
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        for f, im in enumerate(ims):
            ...
            if f == 0:  # init
                segmentation_algorithm = SiamMaskVideoTrackingAlgorithm(im, init_rect)
