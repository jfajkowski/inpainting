...
parser.add_argument('--frames-dir', type=str, default='data/raw/DAVIS/JPEGImages/480p')
parser.add_argument('--interim-dir', type=str, default='data/interim/DAVIS/JPEGImages/480p')
...
frames_dataset = SequenceDataset(frame_dirs, frame_type=opt.frame_type,
                                 transform=transforms.Compose([
                                     transforms.CenterCrop(opt.crop[::-1], opt.frame_type),
