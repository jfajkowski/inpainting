...
class PartialConvolutionUNet(nn.Module):
    def __init__(self):
        ...
        self.e_conv1 = PartialConvolutionDown(3, 64, 7, bn=False)
        self.e_conv2 = PartialConvolutionDown(64, 128, 5)
        self.e_conv3 = PartialConvolutionDown(128, 256, 5)
        self.e_conv4 = PartialConvolutionDown(256, 512, 3)
        self.e_conv5 = PartialConvolutionDown(512, 512, 3)
        self.e_conv6 = PartialConvolutionDown(512, 512, 3)
        self.e_conv7 = PartialConvolutionDown(512, 512, 3)

        self.d_conv7 = PartialConvolutionUp(1024, 512, 3)
        self.d_conv6 = PartialConvolutionUp(1024, 512, 3)
        self.d_conv5 = PartialConvolutionUp(1024, 512, 3)
        self.d_conv4 = PartialConvolutionUp(768, 256, 3)
        self.d_conv3 = PartialConvolutionUp(384, 128, 3)
        self.d_conv2 = PartialConvolutionUp(192, 64, 3)
        self.d_conv1 = PartialConvolutionUp(67, 3, 3, bn=False)
...
class PartialConvolutionAutoencoder(nn.Module):
    def __init__(self):
        ...
        self.d_conv7 = PartialConvolutionUp(512, 512, 3)
        self.d_conv6 = PartialConvolutionUp(512, 512, 3)
        self.d_conv5 = PartialConvolutionUp(512, 512, 3)
        self.d_conv4 = PartialConvolutionUp(512, 256, 3)
        self.d_conv3 = PartialConvolutionUp(256, 128, 3)
        self.d_conv2 = PartialConvolutionUp(128, 64, 3)
        self.d_conv1 = PartialConvolutionUp(64, 3, 3, bn=False)
        self.out = nn.Conv2d(3, 3, 1)
    ...
    def forward(self, image_in, mask_in):
        ...
        d_image_out7, d_mask_out7 = self.d_conv7(e_image_out7, e_mask_out7)
...
class PartialConvolutionDown(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, bn=True):
        super(PartialConvolutionDown, self).__init__()
...
class PartialConvolutionUp(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, bn=True):
        super(PartialConvolutionUp, self).__init__()
    ...
    def forward(self, image_in1, mask_in1, image_in2=None, mask_in2=None):
        image_up = F.interpolate(image_in1, scale_factor=2)
        mask_up = F.interpolate(mask_in1, scale_factor=2)
        if image_in2 is None and mask_in2 is None:
            image_in = image_up
            mask_in = mask_up
        else:
